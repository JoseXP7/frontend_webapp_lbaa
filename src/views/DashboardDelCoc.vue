...
const deleteStudent = async (id) => {
  try {
    ...
    Swal.fire({
      ...
      text: 'El cocinero ha sido eliminado correctamente',
    })
    cocineros.value = []
  } catch (error) {
    Swal.fire({
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr
                    v-for="coc in cocineros"
                    :key="coc.id"
                    v-if="cocineros.length > 0"
                  >
                    <td>{{ coc.id }}</td>
                    <td>{{ coc.cedula }}</td>
                    <td>{{ coc.nombres }}</td>
