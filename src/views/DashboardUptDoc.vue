...
const getUnDocente = async () => {
  if (search.value == '') {
    ...
    try {
      const response = await api.get(`/docentes/${Number(search.value)}`)
      docentes.value = response.data.body
    } catch (error) {
      console.log(error)
    }
...
const getUniqueDocModal = async (ci) => {
  try {
    const response = await api.get(`/docentes/${ci}`)
    uqDocente.value = response.data.body
                    ...
                    <td>
                      ...
                      >
                        <button
                          ...
                          @click="getUniqueDocModal(docente.cedula)"
                        >
              ...
              >
                ...
                <li class="list-group-item">
                  ...
                  <button
                    ...
                    @click="updateDocente(docente.id)"
                    data-bs-dismiss="modal"
                  >
                    Actualizar
                  </button>
